...
import SupportDeskRoutes from './features/skyportcare-support-desk/SupportDeskRoutes.jsx'
import {
...
/** Authenticated app + main layout (everything except public customer-only routes). */
      ...
      <Layout>
        <DigitalToolsPublicRouteGuard>
          <Routes>
            ...
            <Route path="/internal/support-desk/*" element={<SupportDeskRoutes />} />
